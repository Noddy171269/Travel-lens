...
import { Compass, Mail, Lock, ArrowRight, User } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-accent/8 rounded-full blur-[120px]" />
        <div className="absolute bottom-1/3 left-1/4 w-80 h-80 bg-primary/8 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="w-full max-w-md animate-slide-up relative">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-text-secondary mt-1">
            Start planning trips with TravelLens
          </p>
        </div>
